...
public interface EntiteService {
    ...
    EntiteCommerciale trouverParGestionnaire(Long gestionnaireId);
 // Dans EntiteService.java
    List<EntiteCommerciale> trouverToutesParGestionnaire(Long gestionnaireId);
    
    // ✅ AJOUT : Trouver l'entité d'un employé
    EntiteCommerciale trouverParEmploye(Long personneId);
